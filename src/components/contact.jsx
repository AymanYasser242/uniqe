...
const Contact = () => {
  return (
    <section
      className="contact bg-[url('/waves.svg')] bg-cover py-20 bg-gray-100 text-center bg-no-repeat bg-top min-h-[30vh] flex flex-col items-center justify-center "
      id="contact"
    >
      <div className="max-sm:px-5 mx-auto ">
        <section className=" max-w-lg mx-auto">
          <div className="flex items-center space-x-2 mb-4 justify-center">
            <span className="w-5 rounded h-1 bg-lime-700 block" />
            <h4 className="m-0 text-base text-lime-700 font-semibold capitalize">
              Our Contacts
            </h4>
            <span className="w-5 rounded h-1 bg-lime-700 block" />
          </div>
